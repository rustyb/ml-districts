...
gulp.task('styles', function () {
  return gulp.src('app/assets/styles/main.scss')
    ...
    .pipe($.sass({
      ...
      includePaths: require('node-bourbon').with('node_modules/jeet/scss', require('ui-seed/gulp-addons').scssPath, require('ml-design/gulp-addons').scssPath)
    }))
    .pipe($.sourcemaps.write())
...
gulp.task('images', function () {
  return gulp.src(['app/assets/graphics/**/*', require('ml-design/gulp-addons').graphicsPath + '/**/*'])
    .pipe($.cache($.imagemin([
